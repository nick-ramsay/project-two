...
(centre_name, phone, email, user_username, user_password, address_street, address_city, address_postcode, address_state, address_country, latitude, longitude, employee_count, created_date, created_time, createdAt, updatedAt)
VALUES 
	("rob's auto repairs", "0410100100", "rob@gmail.com", "rob@gmail.com", "asdf1234", "1 A Street", "Aaa City", "2000", "NSW", "Australia", 10.1, 10.1, 3, "2019-11-03", "12:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
    ("marks's servicing", "0410200100", "mark@gmail.com", "mark@gmail.com", "asdf1234", "1 B Street", "Bbb City", "2000", "NSW", "Australia", 10.1, 10.1, 3, "2019-11-03", "12:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
    ("john's custom cars", "0410300100", "john@gmail.com", "john@gmail.com", "asdf1234", "1 C Street", "Ccc City", "2000", "NSW", "Australia", 10.1, 10.1, 3, "2019-11-03", "12:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
    ("kevin's auto repairs", "0440100100", "kevin@gmail.com", "kevin@gmail.com", "asdf1234", "1 D Street", "Ddd City", "2000", "NSW", "Australia", 10.1, 10.1, 3, "2019-11-03", "12:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
    ("brian's auto repairs", "0410500100", "brian@gmail.com", "brian@gmail.com", "asdf1234", "1 E Street", "Eee City", "2000", "NSW", "Australia", 10.1, 10.1, 3, "2019-11-03", "12:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00");
...
CREATE TABLE IF NOT EXISTS MechanicCentreServices (
	...
	updatedAt TIMESTAMP,
	PRIMARY KEY (id),
	FOREIGN KEY (mechanic_centre_id) REFERENCES MechanicCentres(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
VALUES 
	(1, "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "00:00:00", "00:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
	(2, "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "00:00:00", "00:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
	(3, "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "00:00:00", "00:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
	(4, "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "00:00:00", "00:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00"),
	(5, "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "09:30:00", "06:30:00", "00:00:00", "00:00:00", "2019-11-03 12:00:00", "2019-11-03 12:00:00");
...
CREATE TABLE IF NOT EXISTS Appointments (
	...
	PRIMARY KEY (id),
	FOREIGN KEY (mechanic_centre_id) REFERENCES MechanicCentres(id) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (required_service_id) REFERENCES Services(id) ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO Appointments (mechanic_centre_id, required_service_id, appointment_date, appointment_time, phone, email, car_plate, car_brand, car_model, additional_notes, createdAt, updatedAt)
VALUES 
